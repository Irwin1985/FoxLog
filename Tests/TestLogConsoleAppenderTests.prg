Define Class TestLogConsoleAppenderTests As FxuTestCase Of FxuTestCase.prg

	#If .F.
		Local This As TestLogConsoleAppenderTests Of TestLogConsoleAppenderTests.prg
	#Endif
	icTestPrefix = "Test"
	cProcAct = ""
	oLogger = .Null.
...
&& ======================================================================== &&
	Function Setup
		...
		This.oLogger = Createobject("Logger", "ConsoleAppender")
	Endfunc
&& ======================================================================== &&
&& Function TearDown
&& ======================================================================== &&
